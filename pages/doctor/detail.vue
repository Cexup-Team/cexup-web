<script setup lang="ts">
    ...
    onMounted(async () => {
        ...
        try {
            ...
            medical.getTemperature(user_code)
            medical.getSPO2(user_code)
            medical.getHeartRate(user_code)
            medical.getRespiration(user_code)
            medical.getBloodPressure(user_code)
