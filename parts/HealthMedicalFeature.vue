...
<template>
  <div class="feature mt-4">
        <!-- <div class="feature-list no-scrollbar overflow-x-auto whitespace-nowrap w-full transition-all duration-300">
                <div class="relative slide-feature flex ml-4 w-full pt-6 pb-6">
